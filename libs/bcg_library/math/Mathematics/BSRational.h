...
template<typename UInteger>
inline bcg::BSRational<UInteger> acos(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::acos((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> acosh(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::acosh((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> asin(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::asin((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> asinh(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::asinh((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> atan(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::atan((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> atanh(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::atanh((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> atan2(bcg::BSRational<UInteger> const &y, bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::atan2((double) y, (double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> ceil(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::ceil((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> cos(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::cos((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> cosh(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::cosh((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> exp(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::exp((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> exp2(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::exp2((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> fabs(bcg::BSRational<UInteger> const &x) {
    return (x.GetSign() >= 0 ? x : -x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> floor(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::floor((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> fmod(bcg::BSRational<UInteger> const &x, bcg::BSRational<UInteger> const &y) {
    return (bcg::BSRational<UInteger>) std::fmod((double) x, (double) y);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> frexp(bcg::BSRational<UInteger> const &x, int *exponent) {
    bcg::BSRational<UInteger> result = x;
...
template<typename UInteger>
inline bcg::BSRational<UInteger> ldexp(bcg::BSRational<UInteger> const &x, int exponent) {
    bcg::BSRational<UInteger> result = x;
...
template<typename UInteger>
inline bcg::BSRational<UInteger> log(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::log((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> log2(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::log2((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> log10(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::log10((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> pow(bcg::BSRational<UInteger> const &x, bcg::BSRational<UInteger> const &y) {
    return (bcg::BSRational<UInteger>) std::pow((double) x, (double) y);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> sin(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::sin((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> sinh(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::sinh((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> sqrt(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::sqrt((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> tan(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::tan((double) x);
}

template<typename UInteger>
inline bcg::BSRational<UInteger> tanh(bcg::BSRational<UInteger> const &x) {
    return (bcg::BSRational<UInteger>) std::tanh((double) x);
}

// Type trait that says BSRational is a signed type.
template<typename UInteger>
struct is_signed<bcg::BSRational<UInteger>> : true_type {
};
}
...
template<typename UInteger>
inline BSRational<UInteger>
clamp(BSRational<UInteger> const &x, BSRational<UInteger> const &xmin, BSRational<UInteger> const &xmax) {
