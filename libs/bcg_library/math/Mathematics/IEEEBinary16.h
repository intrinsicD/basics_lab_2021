...
namespace std {
inline bcg::IEEEBinary16 acos(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::acos(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 acosh(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::acosh(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 asin(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::asin(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 asinh(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::asinh(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 atan(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::atan(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 atanh(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::atanh(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 atan2(bcg::IEEEBinary16 y, bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::atan2(static_cast<float>(y), static_cast<float>(x)));
}

inline bcg::IEEEBinary16 ceil(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::ceil(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 cos(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::cos(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 cosh(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::cosh(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 exp(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::exp(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 exp2(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::exp2(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 fabs(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::fabs(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 floor(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::floor(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 fmod(bcg::IEEEBinary16 x, bcg::IEEEBinary16 y) {
    return static_cast<bcg::IEEEBinary16>(std::fmod(static_cast<float>(x), static_cast<float>(y)));
}

inline bcg::IEEEBinary16 frexp(bcg::IEEEBinary16 x, int *exponent) {
    return static_cast<bcg::IEEEBinary16>(std::frexp(static_cast<float>(x), exponent));
}

inline bcg::IEEEBinary16 ldexp(bcg::IEEEBinary16 x, int exponent) {
    return static_cast<bcg::IEEEBinary16>(std::ldexp(static_cast<float>(x), exponent));
}

inline bcg::IEEEBinary16 log(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::log(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 log2(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::log2(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 log10(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::log10(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 pow(bcg::IEEEBinary16 x, bcg::IEEEBinary16 y) {
    return static_cast<bcg::IEEEBinary16>(std::pow(static_cast<float>(x), static_cast<float>(y)));
}

inline bcg::IEEEBinary16 sin(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::sin(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 sinh(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::sinh(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 sqrt(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::sqrt(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 tan(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::tan(static_cast<float>(x)));
}

inline bcg::IEEEBinary16 tanh(bcg::IEEEBinary16 x) {
    return static_cast<bcg::IEEEBinary16>(std::tanh(static_cast<float>(x)));
}
}
