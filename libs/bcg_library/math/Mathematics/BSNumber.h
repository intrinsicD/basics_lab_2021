...
template<typename UInteger>
inline bcg::BSNumber<UInteger> acos(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::acos((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> acosh(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::acosh((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> asin(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::asin((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> asinh(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::asinh((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> atan(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::atan((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> atanh(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::atanh((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> atan2(bcg::BSNumber<UInteger> const &y, bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::atan2((double) y, (double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> ceil(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::ceil((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> cos(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::cos((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> cosh(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::cosh((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> exp(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::exp((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> exp2(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::exp2((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> fabs(bcg::BSNumber<UInteger> const &x) {
    return (x.GetSign() >= 0 ? x : -x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> floor(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::floor((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> fmod(bcg::BSNumber<UInteger> const &x, bcg::BSNumber<UInteger> const &y) {
    return (bcg::BSNumber<UInteger>) std::fmod((double) x, (double) y);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> frexp(bcg::BSNumber<UInteger> const &x, int *exponent) {
    if (x.GetSign() != 0) {
        bcg::BSNumber<UInteger> result = x;
        *exponent = result.GetExponent() + 1;
        result.SetExponent(-1);
        return result;
    } else {
        *exponent = 0;
        return bcg::BSNumber<UInteger>(0);
    }
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> ldexp(bcg::BSNumber<UInteger> const &x, int exponent) {
    bcg::BSNumber<UInteger> result = x;
...
template<typename UInteger>
inline bcg::BSNumber<UInteger> log(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::log((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> log2(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::log2((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> log10(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::log10((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> pow(bcg::BSNumber<UInteger> const &x, bcg::BSNumber<UInteger> const &y) {
    return (bcg::BSNumber<UInteger>) std::pow((double) x, (double) y);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> sin(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::sin((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> sinh(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::sinh((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> sqrt(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::sqrt((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> tan(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::tan((double) x);
}

template<typename UInteger>
inline bcg::BSNumber<UInteger> tanh(bcg::BSNumber<UInteger> const &x) {
    return (bcg::BSNumber<UInteger>) std::tanh((double) x);
}

// Type trait that says BSNumber is a signed type.
template<typename UInteger>
struct is_signed<bcg::BSNumber<UInteger>> : true_type {
};
}
...
template<typename UInteger>
inline BSNumber<UInteger>
clamp(BSNumber<UInteger> const &x, BSNumber<UInteger> const &xmin, BSNumber<UInteger> const &xmax) {
