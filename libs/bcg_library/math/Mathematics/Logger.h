...
#define LogAssert(condition, message) \
    if (!(condition)) \
    { \
        bcg::Logger(__FILE__, __FUNCTION__, __LINE__, message).Assertion(); \
        throw std::runtime_error(message); \
    }

#define LogError(message) \
    bcg::Logger(__FILE__, __FUNCTION__, __LINE__, message).Error(); \
    throw std::runtime_error(message)

#define LogWarning(message) \
    bcg::Logger(__FILE__, __FUNCTION__, __LINE__, message).Warning()
