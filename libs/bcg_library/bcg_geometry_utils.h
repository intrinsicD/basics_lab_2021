...
#ifndef BCG_GRAPHICS_BCG_GEOMETRY_UTILS_H
#define BCG_GRAPHICS_BCG_GEOMETRY_UTILS_H
...
inline std::pair<vec3f, vec3f> triangle_tangents_fromuv(const vec3f &p0,
                                                        const vec3f &p1, const vec3f &p2, const vec2f &uv0,
                                                        const vec2f &uv1,
                                                        const vec2f &uv2);
...
inline std::pair<vec3f, vec3f> quad_tangents_fromuv(const vec3f &p0, const vec3f &p1,
                                                    const vec3f &p2, const vec3f &p3, const vec2f &uv0,
                                                    const vec2f &uv1,
...
#endif //BCG_GRAPHICS_BCG_GEOMETRY_UTILS_H
