...
struct point_cloud_system : public system {
    ...
    void on_vertex_quadric_fit_knn(const event::point_cloud::vertex::quadric::fit_knn &event);

    void on_vertex_quadric_fit_radius(const event::point_cloud::vertex::quadric::fit_radius &event);
    ...
    void on_vertex_quadric_sum(const event::point_cloud::vertex::quadric::sum &event);

    void on_vertex_quadric_avg(const event::point_cloud::vertex::quadric::avg &event);
